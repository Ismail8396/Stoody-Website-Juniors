...
if($("#course_configuration_page").length){const e=$("#course_configuration_page");let t=$("#course_thumbnail_input_file"),o=$("#course_thumbnail_input_remove"),i=$("#course_promo_video_input_file"),l=$("#course_promo_video_input_name"),n=$("#course_promo_video_input_remove"),a=$("#course_configuration_page_add_section_button"),r=document.getElementById("course_configuration_page_add_section_input"),s=$("#course_configuration_page_curriculum_modal_add_lecture_button"),u=document.getElementById("course_configuration_page_curriculum_modal_input"),c=$("#uploadStartButton"),d=0;function getBlankLecture(){return{title:"",article:new FormData,articleName:"",description:"",locked:!0,uiCollapsed:!1}}function getBlankSection(){return{title:"",lectures:[]}}function getBlankCourse(){return{courseId:-1,congratulationsMessage:"",contextTags:"",courseCategoryId:0,courseStatus:0,currency:"",description:"",discount:"",languageCode:"",level:0,price:0,promoVideoName:"",promoVideoURL:"",sections:[],tags:"",thumbnailName:"",thumbnailURL:"",title:"",welcomeMessage:""}}let p=getBlankCourse();function checkIfObject(e){return"object"==typeof e&&!Array.isArray(e)&&null!==e}function $inputFileHandler(e,t,o,i,l,n){i?(e.hide(),t.show(),t.text(l),o.show(),o.off()):(t.hide(),o.hide(),o.hide(),e.show(),e.val("")),n instanceof Function&&n()}function courseThumbnailInputAdded(){$inputFileHandler(t,$("#course_thumbnail_input_name"),o,!0,p.thumbnailName,null),o.on("click",(function(){$inputFileHandler(t,$("#course_thumbnail_input_name"),o,!1,p.thumbnailName,(function(){p.thumbnailName="",p.thumbnailURL=""}))}))}function coursePromoVideoInputAdded(){$inputFileHandler(i,l,n,!0,p.promoVideoName,null),n.on("click",(function(){$inputFileHandler(i,l,n,!1,p.promoVideoName,(function(){p.promoVideoName="",p.promoVideoURL=""}))}))}function updateStaticFields(){$("#courseTitle").val(p.title),$("#courseContextTags").val(p.contextTags),document.getElementById("editor").querySelector(".ql-editor").innerHTML=p.description,p.thumbnailName.length>0&&courseThumbnailInputAdded(),p.promoVideoName.length>0&&coursePromoVideoInputAdded(),$("#courseCategory").val(p.courseCategoryId),$("#courseLevel").val(p.level),$("#coursePriceInput").val(p.price),$("#coursePriceDiscountInput").val(p.discount),$("#welcomeMessageInput").val(p.welcomeMessage),$("#congratulationMessage").val(p.congratulationsMessage),$("#courseTagsInput").val(p.tags),updateCurriculum()}function updateCurriculum(){let e=$("#courseSectionContents");e.children().off(),e.html("");try{p.sections.length}catch{p.sections=[]}0==p.sections.length?$("#courseSectionEmptyMessage").show():$("#courseSectionEmptyMessage").hide();for(let t=0;t<p.sections.length;t++){let o=$("#courseSectionElementReference").clone();o.show(),o.attr("id",o.attr("id")+t);let i=o.find("#courseSectionElementHeader");i.attr("id",i.attr("id")+t),i.val(p.sections[t].title),i.on("input",(function(){p.sections[t].title=i.val()}));let l=o.find("#courseSectionElementRemoveButton");l.attr("id",l.attr("id")+t),l.on("click",(function(e){p.sections.splice(t,1),updateCurriculum()}));let n=o.find("#sectionLectureList");n.attr("id",n.attr("id")+t);let a=n.find("#courseListElement");a.attr("id",a.attr("id")+t);let r=n.find("#sectionLecturesPasteArea");r.children().off(),r.html("");let s=o.find("#emptySectionMessage");s.attr("id",s.attr("id")+t),p.sections[t].lectures.length<1?s.show():s.hide();for(let e=0;e<p.sections[t].lectures.length;e++){let o=n.find("#lectureDiv").clone();o.attr("id",o.attr("id")+e),o.show();let i=o.find("#articleLockSwitch");i.attr("id",i.attr("id")+t+"_"+e),p.sections[t].lectures[e].locked&&i.attr("checked",!0),i.on("click",(function(){p.sections[t].lectures[e].locked?p.sections[t].lectures[e].locked=!1:p.sections[t].lectures[e].locked=!0}));let l=o.find("#articleLockSwitchLabel");l.attr("id",l.attr("id")+t+"_"+e),l.attr("for",i.attr("id")+t+"_"+e);let s=o.find("#lectureHeader");s.attr("id",s.attr("id")+e),s.val(p.sections[t].lectures[e].title),s.on("input",(function(){p.sections[t].lectures[e].title=s.val()}));let u=o.find("#lectureCollapseList");u.attr("id","lectureCollapseList"+t+"_"+e),u.attr("aria-labelledby",a.attr("id")),u.attr("data-bs-parent",n.attr("id"));let c=o.find("#lectureCollapseButton");c.attr("data-bs-target","#"+u.attr("id")),c.attr("aria-controls",u.attr("id")),0==p.sections[t].lectures[e].uiCollapsed?(c.attr("aria-expanded","true"),u.addClass("show")):(c.addClass("collapsed"),c.attr("aria-expanded","false")),u.on("shown.bs.collapse",(function(){p.sections[t].lectures[e].uiCollapsed=!1})),u.on("hidden.bs.collapse",(function(){p.sections[t].lectures[e].uiCollapsed=!0})),o.find("#lecture_remove").on("click",(function(){p.sections[t].lectures.splice(e,1),updateCurriculum()}));let d=u.find("#lecture_article");d.attr("id",d.attr("id")+e);let m=d.find("#lectureArticleInputFilled");if(m.attr("id",m.attr("id")+e),p.sections[t].lectures[e].articleName.length>0){d.show();let o=d.find("#lecture_article_input_file");o.attr("id",o.attr("id")+e),o.hide();let i=m.find("#lecture_article_input_file_name");i.attr("id",i.attr("id")+e),i.show(),i.text(p.sections[t].lectures[e].articleName);let l=m.find("#lecture_article_input_file_remove");l.show(),l.on("click",(function(){p.sections[t].lectures[e].articleName="",p.sections[t].lectures[e].article=new FormData,updateCurriculum()}))}else{let i=o.find("#lecture_add_article_button");i.show(),i.attr("id",i.attr("id")+e),i.on("click",(function(){d.show();let o=d.find("#lecture_article_input_file");o.on("change",(function(){let i=o.val().replace(/C:\\fakepath\\/i,""),l=new FormData;l.append("file",o[0].files[0]),p.sections[t].lectures[e].article=l,p.sections[t].lectures[e].articleName=i,updateCurriculum()})),i.hide()}))}let f=o.find("#lecture_description");if(f.attr("id",f.attr("id")+e),p.sections[t].lectures[e].description.length>0){f.show();let o=f.find("#lecture_description_input");o.attr("id",o.attr("id")+e),o.val(p.sections[t].lectures[e].description),o.on("input",(function(){p.sections[t].lectures[e].description=$(this).val()}))}else{let i=o.find("#lecture_add_description_button");i.show(),i.attr("id",i.attr("id")+e),i.on("click",(function(){f.show();let o=f.find("#lecture_description_input");o.attr("id",o.attr("id")+e),o.on("input",(function(){p.sections[t].lectures[e].description=$(this).val()})),i.hide()}))}o.appendTo(r)}let u=o.find("#section_add_lecture_button");u.attr("id","section_add_lecture_button"+t),u.on("click",(function(){d=t})),o.appendTo(e)}}function fetchInitialData(){try{if(e.attr("data-course-id","1"),isNaN(e.attr("data-course-id"))||(p.courseId=e.attr("data-course-id")),p.courseId>=0){let e={url:"http://localhost:8080/course/findCourseWithDetails/"+p.courseId,method:"GET",timeout:0};$.ajax(e).done((function(e){try{p=e.response,updateStaticFields(),console.log(e.response),console.log(e.responseStatus)}catch(e){console.log(e),p=getBlankCourse(),updateStaticFields()}}))}}catch(e){p=getBlankCourse(),updateStaticFields(),console.log(e)}}t.on("change",(function(){let e=new FormData;e.append("file",t[0].files[0]),p.thumbnailName=t[0].files[0].name,p.thumbnailURL=e,courseThumbnailInputAdded()})),i.on("change",(function(){let e=new FormData;e.append("file",i[0].files[0]),p.promoVideoName=i[0].files[0].name,p.promoVideoURL=e,coursePromoVideoInputAdded()})),c.on("click",(function(){$("#uploadModal").modal("hide"),$("#courseForm").hide(),$("#courseFormHeader").hide(),$("#uploadForm").show(),$("#courseUploadProgressBarBottomText").show();let e=$("#uploadFormProgressBar"),t=$("#uploadLogger");t.html("");let o=[],i=0,l=0,n=0,a=0,r=0;function s(e){t.html(t.html()+'<span class="bg-dark-warning-soft">'+e+"</span><br>")}function u(e){var t=Math.pow(10,1);return(e=Math.round(e/1024))<1e3?e+" KB":(e=Number.parseFloat(e/1024))<1e3?Math.round(e*t)/t+" MB":(e=Number.parseFloat(e/1024),Math.round(e*t)/t+" GB")}function c(e){e?$("#uploadFormNextButton").on("click",(function(){window.location.href="/"})):$("#uploadFormNextButton").off()}c(!1),p.title=$("#courseTitle").val(),p.title.length<1&&(p.title="Untitled");let d=$("#courseTagsInput").val().length<1?null:JSON.parse($("#courseTagsInput").val()),m="";if(null!=d)for(let e=0;e<d.length;e++)m+=e<1?d[e].value:","+d[e].value;p.tags=m;let f=document.getElementById("courseContextTags").value.length<1?null:JSON.parse(document.getElementById("courseContextTags").value),h="";if(null!=f)for(let e=0;e<f.length;e++)h+=e<1?f[e].value:","+f[e].value;p.contextTags=h,p.courseCategoryId=$("#courseCategory").prop("selectedIndex"),(null==p.courseCategoryId||null==p.courseCategoryId||p.courseCategoryId<0)&&(p.courseCategoryId=1),p.level=$("#courseLevel").prop("selectedIndex"),(null==p.level||null==p.level||p.level<0)&&(p.level=0);let g=document.getElementById("editor").querySelector(".ql-editor").innerHTML;p.description=g,$("#uploadFormCourseTitle").text(p.title),p.price=$("#coursePriceInput").val(),null!=p.price&&null!=p.price||(p.price=0),p.discount=$("#coursePriceDiscountInput").val(),null!=p.discount&&null!=p.discount||(p.discount=0),p.welcomeMessage=$("#welcomeMessageInput").val(),p.congratulationsMessage=$("#congratulationMessage").val(),s("Uploading assets is started..."),s("Checking the assets...");let _=[];if(p.thumbnailName.length>0&&p.thumbnailURL instanceof FormData){l+=p.thumbnailURL.get("file").size,i++;var b={url:"http://localhost:8080/stoody/api/v1/upload/put/small",method:"POST",timeout:0,processData:!1,mimeType:"multipart/form-data",contentType:!1,data:p.thumbnailURL};let t=$.ajax(b).done((function(t){let c=JSON.parse(t),d=c.responseStatus,m=c.response;"SUCCESS"==d?(s(p.thumbnailURL.get("file").name+" uploaded successfully."),r+=p.thumbnailURL.get("file").size,s(u(r)+"/"+u(l)+" uploaded successfully."),p.thumbnailURL=m):(s(p.thumbnailURL.get("file").name+" could not be uploaded."),o.push(p.thumbnailURL.get("file").name+" could not be uploaded.")),n++,a=n/i*100,e.css("width",a+"%")})).fail((function(){s(p.thumbnailURL.get("file").name+" could not be uploaded. Bad Request."),o.push(p.thumbnailURL.get("file").name+" could not be uploaded. Bad Request.")}));_.push(t)}if(p.promoVideoName.length>0&&p.promoVideoURL instanceof FormData){l+=p.promoVideoURL.get("file").size,i++;b={url:"http://localhost:8080/stoody/api/v1/upload/put/small",method:"POST",timeout:0,processData:!1,mimeType:"multipart/form-data",contentType:!1,data:p.promoVideoURL};let t=$.ajax(b).done((function(t){let c=JSON.parse(t),d=c.responseStatus,m=c.response;"SUCCESS"==d?(s(p.promoVideoURL.get("file").name+" uploaded successfully."),r+=p.promoVideoURL.get("file").size,s(u(r)+"/"+u(l)+" uploaded successfully."),p.promoVideoURL=m):(s(p.promoVideoURL.get("file").name+" could not be uploaded."),o.push(p.promoVideoURL.get("file").name+" could not be uploaded.")),n++,a=n/i*100,e.css("width",a+"%")})).fail((function(){s(p.promoVideoURL.get("file").name+" could not be uploaded. Bad Request."),o.push(p.promoVideoURL.get("file").name+" could not be uploaded. Bad Request.")}));_.push(t)}for(let t=0;t<p.sections.length;t++)for(let c=0;c<p.sections[t].lectures.length;c++)try{let d=p.sections[t].lectures[c];if(d.article instanceof FormData){l+=d.article.get("file").size,i++;b={url:"http://localhost:8080/stoody/api/v1/upload/put/small",method:"POST",timeout:0,processData:!1,mimeType:"multipart/form-data",contentType:!1,data:d.article};let t=$.ajax(b).done((function(t){let c=JSON.parse(t),p=c.responseStatus,m=c.response;"SUCCESS"==p?(s(d.article.get("file").name+" uploaded successfully."),r+=d.article.get("file").size,s(u(r)+"/"+u(l)+" uploaded successfully."),d.article=m):(s(d.article.get("file").name+" could not be uploaded."),o.push(d.article.get("file").name+" could not be uploaded.")),n++,a=n/i*100,e.css("width",a+"%")})).fail((function(){s(d.article.get("file").name+" could not be uploaded. Bad Request."),o.push(d.article.get("file").name+" could not be uploaded. Bad Request.")}));_.push(t)}else d.article.length<1&&d.description.length<1&&s("Section: "+t+" Lecture: "+c+" contains neither article nor description.")}catch(e){s("An error occured while uploading: "+e),o.push("An error occured while uploading: "+e)}function v(){$("#courseUploadProgressBarBottomText").hide(),e.css("width","100%"),$("#uploadFormHeaderText").hide(),$("#uploadFormHeaderSpinner").hide(),$("#uploadFormHeaderDoneWithErrorsIcon").show(),$("#uploadFormCompleteButtonSpinner").hide(),o.length>0?s("Uploading assets is failed: "+o):s("Uploading assets is failed..."),s("Course could not be updated."),c(!0)}$.when.apply(null,_).done((function(){checkIfObject(p.description)&&(p.description=JSON.stringify(p.description)),p.description=p.description.trim();for(let e=0;e<p.sections.length;e++)for(let t=0;t<p.sections[e].lectures.length;t++){let o=p.sections[e].lectures[t];checkIfObject(o.article)&&(o.article=JSON.stringify(o.article))}checkIfObject(p.thumbnailURL)&&(p.thumbnailURL=JSON.stringify(p.thumbnailURL)),checkIfObject(p.promoVideoURL)&&(p.promoVideoURL=JSON.stringify(p.promoVideoURL));var e={url:"http://localhost:8080/course/save",method:"POST",timeout:0,headers:{"Content-Type":"application/json"},data:JSON.stringify(p)};$.ajax(e).done((function(e){s("The total size of the uploaded files: "+u(l)),$("#uploadFormHeaderText").hide(),$("#uploadFormHeaderSpinner").hide(),$("#uploadFormHeaderDoneIcon").show(),$("#uploadFormCompleteButtonSpinner").hide(),o.length>0?s("Uploading assets is finished with errors:"+o):s("Uploading assets is finished..."),s("Course is updated."),$("#courseUploadProgressBarBottomText").hide(),c(!0)})).fail((function(){o+=" Request could not be made. Course parameters were invalid.",v()}))})).fail((function(){v()}))})),a.on("click",(function(){if(p.sections.length>=20)return;let e=r.value;if(e.length<1)return;let t=getBlankSection();t.title=e,p.sections.push(t),updateCurriculum()})),s.on("click",(function(){if(p.sections[d].lectures.length>20)return;let e=u.value;if(e.length<1)return;let t=getBlankLecture();t.title=e,console.log(d),p.sections[d].lectures.push(t),updateCurriculum()})),fetchInitialData()}
